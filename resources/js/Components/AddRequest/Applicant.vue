<template>
    <div class="grid gap-2">
        ...
        <TextInput placeholder="Consecutivo EC..." disabled class="bg-gray-300" />
    </div>
    ...
    <div class="grid gap-2">
        <InputLabel class="text-base-more" value="Informacion Adjunta (Máximo 5 Archivos /15mb en total):" />
