...
<template>
    <div class="grid gap-2 flex-1 pt-2 md:p-0">
        ...
        <v-select class="dark:bg-gray-700 dark:text-white rounded-md" v-model="form.buque" taggable :options="projects"
            placeholder="Proyecto..." label="buqueCaso" />
    ...
    <div class="grid scmid995:grid-cols-2 gap-2 w-full">
        <div class="grid gap-2">
            ...
            <select class="border border-stone-300 rounded-lg dark:bg-gray-700 dark:text-white dark:border-none"
                v-model="form.tipoBuque">
    ...
    <div>
        ...
        <ParticipantSelect :options="usersEmails" v-model="form.interesado" placeholder="Interesados..." />
    ...
    <div>
        ...
        <ParticipantSelect class="" :options="usersEmails" v-model="form.solicitante" placeholder="Solicitantes..." />
    ...
    <div class="grid scmid995:grid-cols-2 gap-2 w-full">
        <div class="grid gap-2">
            ...
            <select class="border border-stone-300 rounded-lg w-full dark:bg-gray-700 dark:text-white dark:border-none"
        ...
        <div class="grid gap-2 pt-2 md:p-0">
            ...
            <select class="border border-stone-300 rounded-lg w-full dark:bg-gray-700 dark:text-white dark:border-none"
                v-model="form.servicioSolicitado">
    ...
    <div class="grid gap-2">
        ...
        <TextInput class="bg-gray-300 dark:border-none" disabled placeholder="Solicitud generada por..."
