<template>
    <div aria-label="Loading..." role="status"
        class="absolute flex items-center justify-center space-x-2 w-full h-full bg-[#ffffff8f] mt-2">
        ...
        <span class="text-4xl font-medium text-gray-500">Cargando graficos...</span>
    </div>
</template>